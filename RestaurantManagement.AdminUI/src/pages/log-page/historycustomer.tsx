...
import { GetHistoryCustomer } from "../../services/history-services";
import { Breadcrumb, Col, Pagination, Row, Table } from "antd";
import { Link } from "react-router-dom";

const HistoryCustomerPage = () => {
    const [historyCustomer, setHistoryCustomer] = useState<HistoryOrderDto[]>([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await GetHistoryCustomer(filterUserId, searchTerm, sortColumn, sortOrder, pageIndex, pageSize);
            setHistoryCustomer(result.items);
