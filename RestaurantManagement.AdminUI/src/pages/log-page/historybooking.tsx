...
import { GetHistoryBooking } from "../../services/history-services";
import { Breadcrumb, Col, Pagination, Row, Table } from "antd";
import { Link } from "react-router-dom";

const HistoryBookingPage = () => {
    const [historyBooking, setHistoryBooking] = useState<HistoryOrderDto[]>([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await GetHistoryBooking(filterUserId, searchTerm, sortColumn, sortOrder, pageIndex, pageSize);
            setHistoryBooking(result.items);
