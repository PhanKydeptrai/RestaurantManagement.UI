...
import { GetHistoryBill } from "../../services/history-services";
import { Breadcrumb, Col, Pagination, Row, Table } from "antd";
import { Link } from "react-router-dom";

const HistoryBillPage = () => {
    const [historyBill, setHistoryBill] = useState<HistoryOrderDto[]>([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            const result = await GetHistoryBill(filterUserId, searchTerm, sortColumn, sortOrder, pageIndex, pageSize);
            setHistoryBill(result.items);
